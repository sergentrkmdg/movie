...
const FilmCard = ({film}) => {
  ...
  return (
   <div  onClick={()=>navigate(`detail/${film?.id}`)} className='group border-2 hover:border-4 hover:scale-105 duration-200 rounded-md flex flex-col items-center justify-between ' >
